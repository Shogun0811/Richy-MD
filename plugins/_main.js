...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Ask me a question ex Who is Richy?");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Ask me a question ex Who is Richy");
    }
